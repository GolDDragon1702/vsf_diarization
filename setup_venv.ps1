...
# Run: .\setup_venv.ps1
# Optional flags:
#   .\setup_venv.ps1 -CUDA      # install GPU (CUDA 12.1) version of PyTorch
...
# ── 5. Install PyTorch ────────────────────────────────────────────────────────
if ($CUDA) {
    Write-Host "`nInstalling PyTorch with CUDA 12.1 support ..." -ForegroundColor Cyan
...
Write-Host "`nInstalling project requirements ..." -ForegroundColor Cyan
